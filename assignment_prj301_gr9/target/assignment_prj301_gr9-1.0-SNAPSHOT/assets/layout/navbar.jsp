                    ...
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link">Shop</a>
                                <ul class="dropdown">
                                    <li class="nav-item">
                                        <a class="nav-link" href="Shop.jsp">All</a>
                                    </li> 
                                    <li class="nav-item">
                                        <a class="nav-link" href="Shop.jsp">New</a>
                                    </li>     
                                </ul>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link">Categories</a>
                                <ul class="dropdown">
                                    <li class="nav-item">
                                        <a class="nav-link" href="Product.jsp">T-Shirts</a>
                                    </li> 
                                    <li class="nav-item">
                                        <a class="nav-link" href="Product.jsp">Hoodies</a>
                                    </li> 
                                    <li class="nav-item">
                                        <a class="nav-link" href="Product.jsp">Jackets</a>
                                    </li> 
                                    <li class="nav-item">
                                        <a class="nav-link" href="Product.jsp">Sweaters</a>
                                    </li>     
                                </ul>
                        </li>
                        <li class="nav-item">
