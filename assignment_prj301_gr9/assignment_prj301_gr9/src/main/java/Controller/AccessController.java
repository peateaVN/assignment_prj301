...
//            String searchByTitle = request.getParameter("searchProduct");
//            if (searchByTitle.equals("") || searchByTitle == null) {
//                response.sendRedirect(request.getContextPath() + "/Home.jsp");
//            }
//            list = pd.searchProduct(searchByTitle);
//            HttpSession ss = request.getSession(true);
//            ss.setAttribute("searchList", list);
//
//            response.sendRedirect(request.getContextPath() + "/view/showproduct.jsp");
//
//        }
